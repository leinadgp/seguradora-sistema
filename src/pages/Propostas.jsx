  ...
  async function gerarPolice(prop) {
    ...
    try {
      ...
      await createApolice({
        ...
        seguradora: prop.seguradora || '', seguradoraId: prop.seguradoraId || '', produto: prop.produto || '',
        corretora: prop.corretora || '', corretoraId: prop.corretoraId || '',
        produtor: prop.produtor || '', produtorId: prop.produtorId || '',
        ...
        comissaoValor: prop.comissao || '', comissao: prop.comissao || '',
        comissaoPercentual: prop.percentualComissao || prop.percentualComissaoTotal || prop.percentualComissaoAttenti || '',
        percentualAttenti: prop.percentualComissaoAttenti || '',
        percentualMega: prop.percentualComissaoMega || '',
        coCorretagemAtiva: prop.coCorretagem || false,
...
function KanbanPropostas({ propostas, onDropStatus, onOpen, solicitacoes = [] }) {
                  ...
                  <div key={p.id} draggable
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <div className="flex gap-1 flex-wrap justify-end">
                        ...
                        {(() => {
                          const sol = solicitacoes.find(s => s.origemId === p.id)
                          if (!sol) return null
